...
<body>
    <div class="catagories-side-menu">
        ...
        <div class="nav-side-menu">
            ...
            <h6><a href="index.php" style="padding-left: 15px;"><b>Sign In</b></a></h6>
            <h6><a href="signup.php" style="padding-left: 15px;"><b>Sign Up</b></a></h6>
        </div>
    </div>
    ...
    <div id="wrapper">
                            ...
                            <div class="top_single_area d-flex align-items-center">
                                ...
                                <div class="header-cart-menu d-flex align-items-center ml-auto">
                                    ...
                                    <div class="cart">
                                        ...
                                        <ul class="cart-list">
                                            <li>
                                                <a href="#" class="image"><img src="../static/img/product-img/product-10.jpg" class="cart-thumb" alt=""></a>
                                            ...
                                            <li>
                                                <a href="#" class="image"><img src="../static/img/product-img/product-11.jpg" class="cart-thumb" alt=""></a>
                                                <div class="cart-item-desc">
                                                    <h6><a href="#">Women's Fashion</a></h6>
                                                    <p>1x - <span class="price">$10</span></p>
                                                </div>
        ...
        <section class="welcome_area">
            <div class="welcome_slides owl-carousel">
                <!-- Single Slide Start -->
                <div class="single_slide height-800 bg-img background-overlay" style="background-image: url(../static/img/bg-img/bg-1.jpg);">
                    <div class="container h-100">
                ...
                <!-- Single Slide Start -->
                <div class="single_slide height-800 bg-img background-overlay" style="background-image: url(../static/img/bg-img/bg-4.jpg);">
                    <div class="container h-100">
                        <div class="row h-100 align-items-center">
                            <div class="col-12">
                                <div class="welcome_slide_text">
                ...
                <!-- Single Slide Start -->
                <div class="single_slide height-800 bg-img background-overlay" style="background-image: url(../static/img/bg-img/bg-2.jpg);">
                    <div class="container h-100">
                        <div class="row h-100 align-items-center">
                            <div class="col-12">
                                <div class="welcome_slide_text">
        ...
        <section class="top_catagory_area d-md-flex clearfix">
            <!-- Single Catagory -->
            <div class="single_catagory_area d-flex align-items-center bg-img" style="background-image: url(../static/img/product/Accessories/Glasses-Dark-Brown_$31.JPG);">
            ...
            <!-- Single Catagory -->
            <div class="single_catagory_area d-flex align-items-center bg-img" style="background-image: url(../static/img/product/Accessories/Cross-Body-Bag-Green_$35.JPG);">
                <div class="catagory-content">
                ...
                <div class="row karl-new-arrivals">
                    ...
                    <div class="col-12 col-sm-6 col-md-4 single_gallery_item women wow fadeInUpBig" data-wow-delay="0.2s">
                        ...
                        <div class="product-img">
                            <img src="../static/img/product/Pants/Strap-Pants_$41.JPG" alt="" style="width: 350px ;height:550px;">
                    ...
                    <div class="col-12 col-sm-6 col-md-4 single_gallery_item women wow fadeInUpBig" data-wow-delay="0.3s">
                        <!-- Product Image -->
                        <div class="product-img">
                            <img src="../static/img/product/Pants/Relax-Pants_$43.JPG" alt="" style="width: 350px ;height: 550px;">
                            <div class="product-quicview">
                                <a href="#" data-toggle="modal" data-target="#quickview"><i class="ti-plus"></i></a>
                            </div>
                        </div>
                    ...
                    <div class="col-12 col-sm-6 col-md-4 single_gallery_item access wow fadeInUpBig" data-wow-delay="0.4s">
                        <!-- Product Image -->
                        <div class="product-img">
                             <img src="../static/img/product/Pants/Ultra-Stretch-Dry_$40.JPG" alt="" style="width: 350px ;height:550px;">
                            <div class="product-quicview">
                                <a href="#" data-toggle="modal" data-target="#quickview"><i class="ti-plus"></i></a>
                            </div>
                        </div>
                    ...
                    <div class="col-12 col-sm-6 col-md-4 single_gallery_item shoes wow fadeInUpBig" data-wow-delay="0.5s">
                        <!-- Product Image -->
                        <div class="product-img">
                          <img src="../static/img/product/Shirts/Packet-Shirt_$27.JPG" alt="" style="width: 350px ;height:550px;">
                            <div class="product-quicview">
                                <a href="#" data-toggle="modal" data-target="#quickview"><i class="ti-plus"></i></a>
                            </div>
                        </div>
                    ...
                    <div class="col-12 col-sm-6 col-md-4 single_gallery_item women wow fadeInUpBig" data-wow-delay="0.6s">
                        <!-- Product Image -->
                        <div class="product-img">
                           <img src="../static/img/product/Shirts/Oxford-Slim-Fit-Shirt_$30.JPG" alt="" style="width: 350px ;height:550px;">
                            <div class="product-quicview">
                                <a href="#" data-toggle="modal" data-target="#quickview"><i class="ti-plus"></i></a>
                            </div>
                        </div>
                    ...
                    <div class="col-12 col-sm-6 col-md-4 single_gallery_item kids man wow fadeInUpBig" data-wow-delay="0.7s">
                        <!-- Product Image -->
                        <div class="product-img">
                            <img src="../static/img/product/Shirts/White-Broadcloth-Short-Sleeve-Shirt_$36.JPG" alt="" style="width: 350px ;height:550px;">
                            <div class="product-quicview">
                                <a href="#" data-toggle="modal" data-target="#quickview"><i class="ti-plus"></i></a>
                            </div>
                        </div>
                        <!-- Product Description -->
                        <div class="product-description">
                            <h4 class="product-price">$36</h4>
                            <p>White Broadcloth Short Sleeve Shirt</p>
                            <!-- Add to Cart -->
                            <a href="#" class="add-to-cart-btn">ADD TO CART</a>
                        </div>
                    </div>
        ...
        <!-- ****** Offer Area Start ****** -->
        <section class="offer_area height-700 section_padding_100 bg-img" style="background-image: url(../static/img/bg-img/bg-5.jpg);">
            <div class="container h-100">
...
Copyright &copy;<script>document.write(new Date().getFullYear());</script> Team 10 
